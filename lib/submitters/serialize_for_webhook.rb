    ...
    def call(submitter, expires_at: Accounts.link_expires_at(Account.new(id: submitter.account_id)))
      ...
      submitter.as_json(SERIALIZE_PARAMS)
               .merge('decline_reason' => decline_reason,
                      ...
                      'submission_url' => r.submissions_preview_url(submission.slug, **BermudaSign.default_url_options),
                      ...
                      'submission' => {
                        ...
                        'url' => r.submissions_preview_url(submission.slug, **BermudaSign.default_url_options),
