...
const resp = await fetch("https://api.bermudafranchise.com/submissions", {
  method: "GET",
  headers: {
...
const resp = await fetch("https://api.bermudafranchise.com/submissions/1001", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://api.bermudafranchise.com/submissions/1001/documents", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://api.bermudafranchise.com/submissions/pdf", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/submissions/docx", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/submissions/html", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/submitters", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://api.bermudafranchise.com/submitters/500001", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://api.bermudafranchise.com/templates", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://api.bermudafranchise.com/templates/1000001", {
  method: "GET",
  headers: {
    "X-Auth-Token": "API_KEY"
  }
...
const resp = await fetch("https://api.bermudafranchise.com/templates/pdf", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/templates/docx", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/templates/html", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/templates/1000001/clone", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/templates/merge", {
  method: "POST",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
...
const resp = await fetch("https://api.bermudafranchise.com/templates/1000001/documents", {
  method: "PUT",
  headers: {
    "X-Auth-Token": "API_KEY"
  },
